          ...
          ${filteredEvents.map(game => {
            ...
            return `
              <div class="flex items-center justify-between px-0 min-[450px]:px-4 py-2 border-b border-gray-200 dark:border-gray-800 ${
                ...
                game.isPostseason ? 'bg-green-50 bg-opacity-30 dark:bg-green-900 dark:bg-opacity-20' :
                game.isDoubleHeader ? 'bg-blue-50 bg-opacity-30 dark:bg-blue-900 dark:bg-opacity-20' : ''
              }">
