export function renderScoresControls(showSpringTraining = false) {
  return `
    <div class="flex items-center gap-4">
      ${showSpringTraining ? `
        <button 
          id="spring-training-toggle"
          class="text-sm px-2 py-1 rounded hover:bg-gray-100 dark:hover:bg-gray-800 flex items-center gap-2 text-gray-900 dark:text-gray-100 hidden"
          data-enabled="true"
        >
          Spring Training
